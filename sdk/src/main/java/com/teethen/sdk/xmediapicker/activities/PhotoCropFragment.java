...
import com.teethen.sdk.xmediapicker.cropper.CropImageView;
...
public class PhotoCropFragment extends BaseFragment implements OnClickListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (scheme.equals(ContentResolver.SCHEME_CONTENT)) {
            filePath = MediaUtils.getRealImagePathFromURI(getActivity().getContentResolver(), mMediaItemSelected.getUriOrigin());
