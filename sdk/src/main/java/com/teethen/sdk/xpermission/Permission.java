    ...
    public static List<String> transformText(Context context, List<String> permissions) {
        ...
        for (String permission : permissions) {
            switch (permission) {
                case READ_CALENDAR:
                case WRITE_CALENDAR: {
                    String message = context.getString(R.string.permission_calendar);
                ...
                case WRITE_CONTACTS:
                case GET_ACCOUNTS: {
                    String message = context.getString(R.string.permission_contacts);
                    if (!textList.contains(message)) {
                        textList.add(message);
                    }
                    break;
                ...
                case RECORD_AUDIO: {
                    String message = context.getString(R.string.permission_microphone);
                    if (!textList.contains(message)) {
                        textList.add(message);
                    }
                    break;
                ...
                case PROCESS_OUTGOING_CALLS: {
                    String message = context.getString(R.string.permission_phone);
                    if (!textList.contains(message)) {
                        textList.add(message);
                    }
                    break;
                ...
                case BODY_SENSORS: {
                    String message = context.getString(R.string.permission_sensors);
                    if (!textList.contains(message)) {
                        textList.add(message);
                    }
                    break;
                ...
                case RECEIVE_MMS: {
                    String message = context.getString(R.string.permission_sms);
                    if (!textList.contains(message)) {
                        textList.add(message);
                    }
                    break;
