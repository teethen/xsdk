...
public class SharedPreferencesUtil {
    ...
    public static synchronized SharedPreferencesUtil getInstance(Context context, String file) {
        if(instance == null)
            instance = new SharedPreferencesUtil(context, file);
        return instance;
    }
