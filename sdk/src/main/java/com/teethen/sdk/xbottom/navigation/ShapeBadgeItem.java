...
import com.teethen.sdk.xbottom.navigation.utils.Utils;
...
public class ShapeBadgeItem extends BadgeItem<ShapeBadgeItem> {
    ...
    public static final int SHAPE_OVAL = 0;     //圆形
    public static final int SHAPE_RECTANGLE = 1;//矩形
    public static final int SHAPE_HEART = 2;    //心形
    public static final int SHAPE_STAR_3_VERTICES = 3;//三角形
    public static final int SHAPE_STAR_4_VERTICES = 4;//四角形
    public static final int SHAPE_STAR_5_VERTICES = 5;//五角形
    public static final int SHAPE_STAR_6_VERTICES = 6;//六角形
