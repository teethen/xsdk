package com.teethen.sdk.xwidget.ninegrid.complex;
...
public class ImageInfo implements Serializable {
    ...
    public String toString() {
        return "ImageInfo{" +
                "imageViewY=" + imageViewY + ", imageViewX=" + imageViewX +
                ", imageViewWidth=" + imageViewWidth + ", imageViewHeight=" + imageViewHeight +
                ", bigImageUrl='" + bigImageUrl + "\'" + ", thumbnailUrl='" + thumbnailUrl + "\'}";
    }
}
