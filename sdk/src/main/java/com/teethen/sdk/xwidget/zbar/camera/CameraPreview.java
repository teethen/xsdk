 ...
 * Created by xingq on 2017/12/10.
 */
public class CameraPreview extends FrameLayout implements SurfaceHolder.Callback {
     ...
     *
     * @param callback {@link CameraScanCallback}.
     */
    public void setScanCallback(CameraScanCallback callback) {
    ...
    public boolean setFlashLight(boolean open) {
        ...
        try {
            if (mCameraManager != null) {
                result = mCameraManager.setFlashLight(open);
            }
        } catch (Exception e) {
        }
        return result;
