...
import com.teethen.sdk.xwidget.baseadapter.recyclermore.interfaces.OnLoadMoreListener;
...
public abstract class LoadMoreBaseAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LoadMoreBaseAdapter(Context context, List<T> datas, boolean isOpenLoadMore) {
        mContext = context;
        mDataList = datas == null ? new ArrayList<T>() : datas;
    ...
    public int getItemViewType(int position) {
        ...
        return getViewType(position, mDataList.get(position));
    }
    ...
    public int getFooterViewCount() {
        return mOpenLoadMore && !mDataList.isEmpty() ? 1 : 0;
    }
