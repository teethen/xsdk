...
public class LoadingLayout extends FrameLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mEmptyView == null) {
            mEmptyView = LayoutInflater.from(context).inflate(R.layout.load_empty, null);
            if (mEmptyView != null) {
        ...
        if (mErrorView == null) {
            mErrorView = LayoutInflater.from(context).inflate(R.layout.load_failed, null);
            if (mErrorView != null) {
                TextView errorTv = (TextView) mErrorView.findViewById(R.id.failed_text);
                mErrorText = errorTv.getText().toString().trim();
                ImageView errorImg = (ImageView) mErrorView.findViewById(R.id.failed_img);
