package com.teethen.sdk.xwidget.ninegrid.preview;
...
import com.teethen.sdk.xwidget.photoview.widget.OnPhotoTapListener;
...
public class ImagePreviewAdapter extends PagerAdapter implements OnPhotoTapListener {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_ninegrid_photoview, container, false);
