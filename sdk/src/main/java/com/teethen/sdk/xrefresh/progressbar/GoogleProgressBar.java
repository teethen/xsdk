package com.teethen.sdk.xrefresh.progressbar;
...
public class GoogleProgressBar extends ProgressBar {
    ...
    public GoogleProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int typeIndex = a.getInteger(R.styleable.GoogleProgressBar_type, context.getResources().getInteger(R.integer.default_google_type));
