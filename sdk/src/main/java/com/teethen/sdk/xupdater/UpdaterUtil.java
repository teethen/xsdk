...
public class UpdaterUtil {
    ...
    public static String TAG = "XUpdater";
    ...
    public static Intent getInstallApkIntent(Context context, String apkPath) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                apkUri = FileProvider.getUriForFile(context, getPackageName(context) + ".fileProvider", apkFile);
    ...
    private static final String SP_NAME = "com_teethen_downloader_progress_file";
    ...
    public static void putCurrLengthValue(Context context, String key, long value) {
        getSharedPreferences(context).edit().putLong(key, value).apply();
    }

    public static long getCurrLengthValue(Context context, String key) {
