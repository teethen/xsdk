...
import com.teethen.sdk.xhttp.nohttp.Connection;
import com.teethen.sdk.xhttp.nohttp.Headers;
import com.teethen.sdk.xhttp.nohttp.HttpConnection;
import com.teethen.sdk.xhttp.nohttp.Logger;
import com.teethen.sdk.xhttp.nohttp.NetworkExecutor;
...
import com.teethen.sdk.xhttp.nohttp.tools.NetUtils;
    ...
    private void validateDevice(String savePathDir) throws Exception {
        ...
        if (!IOUtils.createFolder(savePathDir))
            throw new StorageReadWriteError("SD card isn't available, please check SD card and permission: WRITE_EXTERNAL_STORAGE." +
                    "\nYou must pay attention to Android6.0 RunTime Permissions: https://github.com/xingq/AndPermission." +
