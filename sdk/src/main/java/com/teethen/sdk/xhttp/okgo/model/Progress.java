package com.teethen.sdk.xhttp.okgo.model;
...
import com.teethen.sdk.xhttp.okgo.utils.IOUtils;
...
public class Progress implements Serializable {
    ...
    public static Progress changeProgress(final Progress progress, long writeSize, long totalSize, final Action action) {
        ...
        boolean isNotify = (currentTime - progress.lastRefreshTime) >= OkHttp.REFRESH_TIME;
