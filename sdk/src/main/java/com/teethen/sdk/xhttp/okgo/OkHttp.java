package com.teethen.sdk.xhttp.okgo;
...
import com.teethen.sdk.xhttp.okgo.cookie.CookieJarImpl;
import com.teethen.sdk.xhttp.okgo.https.HttpsUtils;
import com.teethen.sdk.xhttp.okgo.interceptor.HttpLoggingInterceptor;
import com.teethen.sdk.xhttp.okgo.model.HttpHeaders;
import com.teethen.sdk.xhttp.okgo.model.HttpParams;
import com.teethen.sdk.xhttp.okgo.request.DeleteRequest;
import com.teethen.sdk.xhttp.okgo.request.GetRequest;
import com.teethen.sdk.xhttp.okgo.request.HeadRequest;
import com.teethen.sdk.xhttp.okgo.request.OptionsRequest;
import com.teethen.sdk.xhttp.okgo.request.PatchRequest;
import com.teethen.sdk.xhttp.okgo.request.PostRequest;
import com.teethen.sdk.xhttp.okgo.request.PutRequest;
import com.teethen.sdk.xhttp.okgo.request.TraceRequest;
...
public class OkHttp {
    ...
    private OkHttp() {
        ...
        builder.readTimeout(OkHttp.DEFAULT_MILLISECONDS, TimeUnit.MILLISECONDS);
        builder.writeTimeout(OkHttp.DEFAULT_MILLISECONDS, TimeUnit.MILLISECONDS);
        builder.connectTimeout(OkHttp.DEFAULT_MILLISECONDS, TimeUnit.MILLISECONDS);
    ...
    public OkHttp init(Application app) {
        context = app;
        return this;
    }
    ...
    public Context getContext() {
        HttpUtils.checkNotNull(context, "please call OkHttp.getInstance().init() first in application!");
        return context;
    }
    ...
    public OkHttpClient getOkHttpClient() {
        HttpUtils.checkNotNull(okHttpClient, "please call OkHttp.getInstance().setOkHttpClient() first in application!");
        return okHttpClient;
    }
