...
import com.teethen.sdk.xhttp.okgo.adapter.CacheCall;
import com.teethen.sdk.xhttp.okgo.adapter.Call;
import com.teethen.sdk.xhttp.okgo.adapter.CallAdapter;
import com.teethen.sdk.xhttp.okgo.cache.CacheEntity;
import com.teethen.sdk.xhttp.okgo.cache.CacheMode;
import com.teethen.sdk.xhttp.okgo.cache.policy.CachePolicy;
import com.teethen.sdk.xhttp.okgo.callback.Callback;
import com.teethen.sdk.xhttp.okgo.convert.Converter;
...
import com.teethen.sdk.xhttp.okgo.request.base.ProgressRequestBody;
import com.teethen.sdk.xhttp.okgo.utils.HttpUtils;
...
/**
 * 描述：所有请求的基类，其中泛型 R 主要用于属性设置方法后，返回对应的子类型，以便于实现链式调用
 */
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public okhttp3.Call getRawCall() {
        ...
        if (client == null) client = OkHttp.getInstance().getOkHttpClient();
