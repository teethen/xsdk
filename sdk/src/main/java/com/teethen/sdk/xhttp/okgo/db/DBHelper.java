package com.teethen.sdk.xhttp.okgo.db;
...
import com.teethen.sdk.xhttp.okgo.cookie.SerializableCookie;
...
class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_CACHE_NAME = "okhttp_wthtra.db";
    ...
    DBHelper() {
        this(OkHttp.getInstance().getContext());
    }
