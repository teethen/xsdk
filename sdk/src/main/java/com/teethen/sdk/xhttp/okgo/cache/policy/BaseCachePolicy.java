package com.teethen.sdk.xhttp.okgo.cache.policy;
...
import com.teethen.sdk.xhttp.okgo.cache.policy.*;
import com.teethen.sdk.xhttp.okgo.callback.Callback;
import com.teethen.sdk.xhttp.okgo.db.CacheManager;
import com.teethen.sdk.xhttp.okgo.exception.HttpException;
import com.teethen.sdk.xhttp.okgo.model.Response;
import com.teethen.sdk.xhttp.okgo.request.base.Request;
import com.teethen.sdk.xhttp.okgo.utils.HeaderParser;
...
public abstract class BaseCachePolicy<T> implements CachePolicy<T> {
    ...
    protected void runOnUiThread(Runnable run) {
        OkHttp.getInstance().getDelivery().post(run);
    }
