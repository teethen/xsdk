...
import com.teethen.sdk.xdialog.dialogui.holder.AlertDialogHolder;
import com.teethen.sdk.xdialog.dialogui.holder.SheetHolder;
...
public class Buildable {
    ...
    private BuildBean buildDatePick(final BuildBean bean) {
        ...
        if (bean != null && !TextUtils.isEmpty(bean.dateTitle)) {
