package com.teethen.sdk.xdialog.dialogui.widget;
...
import com.teethen.sdk.xdialog.dialogui.adapter.StrericWheelAdapter;
import com.teethen.sdk.xdialog.dialogui.listener.OnWheelChangedListener;
        ...
        if (wheel.getId() == wvYear.getId()) {
            ...
            switch (currentMonth) {
                ...
                case 12:
                    ...
                    break;
                case 2:
                    String yearString = (wvYear.getCurrentItemValue()).trim().split(" ")[0];
            ...
            tvDay.setText((wvDay.getCurrentItemValue()).trim().split(" ")[0]);
        } else if (wheel.getId() == wvHour.getId()) {
            tvHour.setText((wvHour.getCurrentItemValue()).trim().split(" ")[0]);
        } else if (wheel.getId() == wvMinute.getId()) {
            tvMinute.setText((wvMinute.getCurrentItemValue()).trim().split(" ")[0]);
        } else if (wheel.getId() == wvSecond.getId()) {
            tvSecond.setText((wvSecond.getCurrentItemValue()).trim().split(" ")[0]);
        }
    }
