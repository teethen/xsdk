package com.teethen.sdk.xdialog.dialogui;
...
import com.teethen.sdk.xdialog.dialogui.listener.DialogAssigner;
...
import com.teethen.sdk.xdialog.dialogui.listener.DialogUIListener;
import com.teethen.sdk.xdialog.dialogui.listener.TdataListener;
import com.teethen.sdk.xdialog.dialogui.utils.ToolUtils;
import com.teethen.sdk.xdialog.dialogui.widget.PopuWindowView;
...
public class DialogUIUtils {
     ...
     * 对mBuildBean的简易封装。线程不安全，不可以在非UI线程调用。
     */
    public static void dismissTie() {
        dismiss(mBuildBean);
    }

    public static void showPopupWindow(Context context, int widthGravity,int maxLine, View view, TdataListener tdataListener) {
